...
public class ZenoRemote : ModuleRules
{
    ...
    protected string GRpcResourcePath => Path.GetFullPath(Path.Combine(ThirdPartyRoot, "grpc"));
    ...
    protected void GenerateProtoFiles()
    {
        ...
        {
            Log.TraceWarningOnce("Protobuf ('{0}') and grpc ('{1}') generator is not found", ProtoCExePath, ProtoCppExePath);
            return;
        }
